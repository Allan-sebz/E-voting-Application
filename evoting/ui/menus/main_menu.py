...
class MainMenu:
    ...
    def display(self):
        ...
        while True:
            ...
            if choice == "1":
                ...
                print()
                info("Goodbye!")
                self.auth_service.data_store.save_data()
                exit()
            else:
    ...
    def admin_login(self):
        ...
        success_result, user_or_error = self.auth_service.authenticate_admin(username, password)
    ...
    def voter_login(self):
        ...
        success_result, user_or_error = self.auth_service.authenticate_voter(voter_card, password)
