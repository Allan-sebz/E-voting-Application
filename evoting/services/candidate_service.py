...
class CandidateService:
    ...
    def create_candidate(
        ...
        for cid, c in self.data_store.get_all_candidates().items():
    ...
    def search_by_name(self, term: str) -> list:
        ...
        term = term.lower()
        return [c for c in self.data_store.get_all_candidates().values()
    ...
    def get_eligible_for_position(self, min_age: int) -> dict:
        ...
        return {
            cid: c for cid, c in self.data_store.get_all_candidates().items()
