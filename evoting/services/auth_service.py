...
class AuthService:
    ...
    def authenticate_admin(self, username: str, password: str) -> tuple:
        """Alias for login_admin."""
        return self.login_admin(username, password)
    
    def authenticate_voter(self, voter_card: str, password: str) -> tuple:
        """Alias for login_voter."""
        return self.login_voter(voter_card, password)
